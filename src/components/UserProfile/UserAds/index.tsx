...
import { Card, Container, Image, InfoContainer, InfoTrashContainer, NoAds, Price, PriceTitleContainer, PublishedText, Title, TotalAds, TrashButton, TrashIcon } from './styled'
    ...
    <Container>
      ...
      {product.length > 0 ? (
        product.map((product)=>(
          ...
          <Card key={product.id} activeOpacity={8.85} onPress={()=>{}}>
            ...
            <InfoContainer>
              ...
              <InfoTrashContainer>
                ...
                <TrashButton activeOpacity={8.85} onPress={()=>{}}>
